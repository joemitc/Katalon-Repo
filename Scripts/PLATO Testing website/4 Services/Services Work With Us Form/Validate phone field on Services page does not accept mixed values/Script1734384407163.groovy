...
WebUI.setText(findTestObject('Object Repository/Page_Services - PLATO Testing - Site/input__tel-131'), 'joe123doe123')

WebUI.click(findTestObject('Object Repository/Page_Services - PLATO Testing - Site/body_Skip to content elementor - v3.21.0 - _c63ced'))

WebUI.verifyElementPresent(findTestObject('Page_Services - PLATO Testing - Site/span_Please enter a telephone number'), 
    0)
