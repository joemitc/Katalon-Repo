...
WebUI.click(findTestObject('Object Repository/LandingPage/a_Services'))

WebUI.verifyEqual('http://3.145.59.133:8202/services/', 'http://3.145.59.133:8202/services/')

WebUI.click(findTestObject('Object Repository/Page_Services - PLATO Testing - Site/input__your-name'))

WebUI.setText(findTestObject('Object Repository/Page_Services - PLATO Testing - Site/input__your-name'), 'joe')

WebUI.click(findTestObject('Object Repository/Page_Services - PLATO Testing - Site/input__text-66'))
