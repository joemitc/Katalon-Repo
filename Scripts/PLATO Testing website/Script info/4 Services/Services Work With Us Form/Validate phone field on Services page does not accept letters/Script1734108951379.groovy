...
WebUI.setText(findTestObject('Object Repository/Page_Services - PLATO Testing - Site/input__tel-131'), 'abcdefg')

WebUI.click(findTestObject('Object Repository/Page_Services - PLATO Testing - Site/div_Email  Please fill out this field'))

WebUI.verifyElementPresent(findTestObject('Object Repository/Page_Services - PLATO Testing - Site/span_Please enter a telephone number'), 
    0)
