...
WebUI.click(findTestObject('Page_Services - PLATO Testing - Site/input__tel-131'))

WebUI.setText(findTestObject('Object Repository/Page_Services - PLATO Testing - Site/input__tel-131'), '1234567')
