...
WebUI.setText(findTestObject('Object Repository/Page_Services - PLATO Testing - Site/input__tel-131'), '123456789012')

WebUI.rightClick(findTestObject('Object Repository/Page_Services - PLATO Testing - Site/p_Phone'))

WebUI.rightClick(findTestObject('Object Repository/Page_Services - PLATO Testing - Site/input__tel-131'))
