...
WebUI.setText(findTestObject('Object Repository/Page_Services - PLATO Testing - Site/input_Company_text-132'), 'Company Inc.')

WebUI.setText(findTestObject('Object Repository/Page_Services - PLATO Testing - Site/textarea__textarea-734'), 'My project')

WebUI.click(findTestObject('Object Repository/Page_Services - PLATO Testing - Site/div__submit-button'))
