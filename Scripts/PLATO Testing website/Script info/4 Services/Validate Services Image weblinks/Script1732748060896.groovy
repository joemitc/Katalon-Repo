...
WebUI.click(findTestObject('Object Repository/Page_Services - PLATO Testing - Site/img_Services_attachment-full size-full wp-i_a12d8c'))
...
WebUI.click(findTestObject('Object Repository/Page_Services - PLATO Testing - Site/img_Full List Of Testing Services_attachmen_ed7cef'))
